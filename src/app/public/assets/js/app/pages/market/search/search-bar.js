...
// Fichero que contiene la lógica de funcionamiento del campo de búsqueda de productos de la barra de navegación
...
$searchBarInput.on('keyup', async e => {
    ...
    formData.append(V_PRODUCTO_VALORACION_PROMEDIO.NOMBRE, nombreProducto);
    const response = await ajax(END_POINTS.SEARCH_BAR, 'POST', formData);
