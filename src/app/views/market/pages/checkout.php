        ...
        <div class="productos-container">
            ...
            foreach ($cartItems as $cartItem) { ?>
                <article class="producto-container">
                    <div class="producto">
                        <img src="<?php echo $cartItem -> rutaImagenProducto; ?>" alt="Imagen Producto">
                        <div class="producto__detalles">
                            <p class="producto__nombre"><?php echo $cartItem -> nombreProducto; ?></p>
                            <p class="producto__precio">Precio: <span><?php echo $cartItem -> precioProducto; ?></span> €</p>
                            <p class="producto__cantidad">Cantidad: <span><?php echo $cartItem -> cantidad; ?></span></p>
                        </div>
                    </div>
                    <?php
                    $total += $cartItem -> precioProducto * $cartItem -> cantidad;
                    ?>
                    <p class="producto__total">Total: <span><?php echo $cartItem -> precioProducto * $cartItem -> cantidad; ?></span> €</p>
                </article>
                <?php
            }
            ?>
